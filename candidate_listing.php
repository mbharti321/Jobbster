...
-->
      ...
      <div class="col-lg-9">
        <div class="row mb-4">
          <div class="col-12">
            <h6 class="mb-0">Showing 1-5 of <span class="text-primary">11 Candidates</span></h6>
          </div>
        </div>
...
<!--
          ...
          <div class="col-12">
            <div class="candidate-list">
              ...
              <div class="candidate-list-favourite-time">
                <a class="candidate-list-favourite order-2" href="#"><i class="far fa-heart"></i></a>
                <span class="candidate-list-time order-1"><i class="far fa-clock pr-1"></i>2W ago</span>
              </div>
            </div>
          </div>
          <div class="col-12">
            ...
            <div class="candidate-list">
              ...
              <div class="candidate-list-details">
                <div class="candidate-list-info">
                  ...
                  <div class="candidate-list-option">
                    <ul class="list-unstyled">
                      <li><i class="fas fa-filter pr-1"></i>Apprenticeships</li>
            ...
            <div class="candidate-list">
              ...
              <div class="candidate-list-details">
                <div class="candidate-list-info">
                  ...
                  <div class="candidate-list-option">
                    <ul class="list-unstyled">
                      <li><i class="fas fa-filter pr-1"></i>EHealth & Medicine</li>
            ...
            <div class="candidate-list">
              ...
              <div class="candidate-list-details">
                <div class="candidate-list-info">
                  ...
                  <div class="candidate-list-option">
                    <ul class="list-unstyled">
                      <li><i class="fas fa-filter pr-1"></i>Marketing & PR</li>
                      <li><i class="fas fa-map-marker-alt pr-1"></i>Burry Port, Surat</li>
                    </ul>
                  </div>
                </div>
              </div>
              <div class="candidate-list-favourite-time">
                <a class="candidate-list-favourite order-2" href="#"><i class="far fa-heart"></i></a>
                <span class="candidate-list-time order-1"><i class="far fa-clock pr-1"></i>1D ago</span>
              </div>
            </div>
          </div>
-->
...
<!-- Mirrored from themes.potenzaglobalsolutions.com/html/jobber/candidates-listing.html by HTTrack Website Copier/3.x [XR&CO'2014], Thu, 13 Aug 2020 08:54:08 GMT -->
</html>
