...
background: linear-gradient(294deg, rgba(34,193,195,1) 0%, #ddd 0%);
  }
  </style>
<body>
    <!-- ? Preloader Start -->
                        ...
                        <div class="row">
                            <div class="col-xl-8 col-lg-11 col-md-12">
                                <div class="hero__caption hero__caption2">
                                    <h1 data-animation="bounceIn" data-delay="0.2s">Communication Skills</h1>
                                    <!-- breadcrumb Start-->
...
<th>CATEGORY</th></tr>
<?php
$sql="SELECT * FROM food WHERE category='Communication Skills'";
