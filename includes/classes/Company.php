<?php
 ...
 // `tbl_company` (`company_id`, `cname`, `logo`, `address`, `contact_no`, `email_id`, `state`, `city`, `username`, `password`, `status`)
        ...
        // $companyId, $comUsername, $cname, $email, $contact, $address, $state, $city

        public function updateCompany($companyId, $un, $cname, $eml, $contact, $add, $state, $city) {
            ...
            if(empty($this->errorArray) == true) {
                ...
                return $this->updateCompanyDetails($companyId, $un, $cname, $eml, $contact, $add, $state, $city);
            }
            else {
                return false;
            }
        ...
        private function updateCompanyDetails($companyId, $un, $cname,  $eml, $contact, $add, $state, $city){
             // `tbl_company` (`company_id`, `cname`, `logo`, `address`, `contact_no`, `email_id`, `state`, `city`, `username`, `password`, `status`

            
            $updateQuery = "UPDATE  tbl_company set  cname = '$cname',
                                email_id = '$eml', address = '$add', state = '$state', city = '$city',
                                contact_no = '$contact', username = '$un'
        ...
        private function updatePassword($un, $pw){
            ...
            $updateQuery = "Update  tbl_company set password = '$pw' where username = '$un'";
            $result = mysqli_query($this->con, $updateQuery);
            return $result;
        }
        ...
        private function validateOldPasswords($un, $currentPw){
            ...
            $checkPasswordQuery = mysqli_query($this->con, "SELECT * FROM tbl_company WHERE username='$un' AND password = '$currentPw'");
