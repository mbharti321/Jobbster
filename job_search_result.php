...
//        session_start(); 
//    } 
//    if (isset($_SESSION['city']) && isset($_SESSION['title'])) 
//    {
//        $city = $_SESSION['city'];
...
//                $cid=$_GET['cid'];
                    ...
                    {
                        $sql = "SELECT * FROM tbl_company join tbl_job_post ON tbl_company.company_id = tbl_job_post.company_id
                                  join tbl_job_type ON tbl_job_type.job_type_id = tbl_job_post.job_type_id where tbl_job_post.city='$city'";
                    }
                    else if($city!="" && $title!="") 
                    {
                        $sql = "SELECT * FROM tbl_company join tbl_job_post ON tbl_company.company_id = tbl_job_post.company_id
                                  join tbl_job_type ON tbl_job_type.job_type_id = tbl_job_post.job_type_id where tbl_job_post.city='$city' and tbl_job_post.job_title='$title'";
                    }
                    else
                    {
                        echo "No Result";
...
//                $sql = "SELECT * FROM tbl_company join tbl_job_post ON tbl_company.company_id = tbl_job_post.company_id
//                                  join tbl_job_type ON tbl_job_type.job_type_id = tbl_job_post.job_type_id where tbl_job_post.city='$city' or tbl_job_post.job_title='$title'";
