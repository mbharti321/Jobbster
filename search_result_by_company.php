                    ...
                    <div class="row mb-4">
                       <div class="col-md-6">
                        <div class="section-title mb-3 mb-lg-4">
                          <h6 class="mb-0">Showing 1-5 of <span class="text-primary">10 Jobs</span></h6>
                        </div>
                      </div>
                      <div class="col-md-6">
...
<!--                          <li><a class="filter-clear" href="job_listing_byCompany.php?cid=$cid">Reset Search <i class="fas fa-redo-alt"></i> </a></li>-->
                        </ul>
                      </div>
                      </div>
                    </div>
...
//                $cid=$_GET['cid'];
                    ...
                    if ($company=="" && $title!="") 
                    {
                        $sql = "SELECT * FROM tbl_company join tbl_job_post ON tbl_company.company_id = tbl_job_post.company_id
                                  join tbl_job_type ON tbl_job_type.job_type_id = tbl_job_post.job_type_id where tbl_job_post.job_title='$title'";
                        
                    }
                    else if($company!="" && $title=="") 
                    {
                        $sql = "SELECT * FROM tbl_company join tbl_job_post ON tbl_company.company_id = tbl_job_post.company_id
                                  join tbl_job_type ON tbl_job_type.job_type_id = tbl_job_post.job_type_id where tbl_company.cname='$company'";
                    }
                    else if($company!="" && $title!="") 
                    {
                        $sql = "SELECT * FROM tbl_company join tbl_job_post ON tbl_company.company_id = tbl_job_post.company_id
                                  join tbl_job_type ON tbl_job_type.job_type_id = tbl_job_post.job_type_id where tbl_company.cname='$company' and tbl_job_post.job_title='$title'";
                    }
                    else
                    {
                        echo "No Result";
