...
<?php        
    $output = '';
    if(isset($_POST['loginAsCandidate']) && isset($_POST['username']) && isset($_POST['password']) ) 
    {
...
<div class="header-inner bg-light text-center">
  <div class="container">
    <div class="row">
      <div class="col-12">
        <h2 class="text-primary">Log In As Candidate</h2>
...
<!--          <h4 class="text-center">Log In</h4>-->
          ...
          <div class="tab-content">
            <div class="tab-pane active" id="candidate" role="tabpanel">
              <form class ="mt-4" method="post" onsubmit="" action="" namr ="f1" id="f1">
                <div class="form-row">
                ...
                <div class="form-row">
                  <div class="col-md-6">
                      <input type ="submit" class="btn btn-primary btn-block" id = "loginAsCandidate" name="loginAsCandidate" value = "Login" />  
